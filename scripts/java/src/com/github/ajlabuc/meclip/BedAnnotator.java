...
public class BedAnnotator {
	...
	public static void main(String[] args) throws IOException {
		...
		bufferedWriter.write("Gene\tAnnotation\tChromosome\tm6A\tStrand\tMutations\tReads\tFrequency\n");
		...
		while ((line1_bed = bufferedReader.readLine()) != null) {
			...
			String[] line1_description = line1_fileContents[9].split("\\|");
			String line1_gene = line1_description[1];
			String line1_annotation = line1_description[2].toUpperCase();
			...
			bufferedWriter.write(line1_gene + '\t' + line1_annotation + '\t' + line1_chr + '\t' + line1_start + '\t'
					+ line1_strand + '\t' + line1_mutations + '\t' + line1_reads + '\t' + line1_freq + '\n');
		}
